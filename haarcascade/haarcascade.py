...
mascara = cv2.imread(r'C:\Users\sresm\Documents\ARCHIVOS TEMPORALES\Graficacion\Actividades\haarcascade\perro.png', cv2.IMREAD_UNCHANGED)  # Cargar PNG con transparencia

# Cargar el clasificador preentrenado de rostros
face_cascade = cv2.CascadeClassifier(r'C:\Users\sresm\Documents\ARCHIVOS TEMPORALES\Graficacion\Actividades\haarcascade\clasificador.xml')
